...
class _ZoomableImageState extends State<ZoomableImage> {
  ImageStreamListener imListener;

  @override
  initState() {
    super.initState();

    imListener = ImageStreamListener(_handleImageLoaded);
  }
  ...
  void _resolveImage() {
    ...
    _imageStream.addListener(imListener);
  }
  ...
  @override
  void dispose() {
    _imageStream.removeListener(imListener);
    super.dispose();
  }
}
